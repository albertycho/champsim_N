...
parser.add_argument('--champsim_dir', type=str,
                    default='PATH_TO_YOUR_CHAMPSIM_REPO')
...
#                    default='AMD64_cxl_DRAMSIM_base.cfg')
#parser.add_argument('--command', type=str, default='ls')
parser.add_argument('--tr', type=str, default='PATH_TO_YOUR_TRACE_CMD') #trace
parser.add_argument('--wi', type=str, default='10000000') #warmup insts
